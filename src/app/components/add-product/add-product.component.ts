...
export class AddProductComponent implements OnInit {
  ...
  constructor(private date: DateService, private data: DataService, private productsComponent: ProductsComponent) { }
  ...
  addProduct() {
    ...
    this.data.postProduct(this.addProductForm.value).subscribe((res) => {
